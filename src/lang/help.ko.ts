...
export const helpKo = {
        ...
        "risuBardWikiLanguageSync": "켜면 위키 작성 언어 설정을 무시하고 최근 채팅 메시지의 문자 종류(가나 → 일본어, 한글 → 한국어, 라틴 → 영어)로 위키 언어를 강제합니다. 채팅 언어와 위키 언어를 통일해 어휘 기반 검색 정확도를 유지할 때 사용하세요. 현재 챗 단위 설정도 따릅니다.",
